...
public:
  ...
  TString GetParameter(const char* aKeyword, const char* aDefault) noexcept;
 ...
 */
/*! @class Configurator
 * @brief Class contains parameters for <c><b>THERMINATOR 2</b></c> that are stored in the
 * <em>ini</em> type files.
 *
 * @ref file_type_ini
