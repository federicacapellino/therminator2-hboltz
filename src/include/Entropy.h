 ...
 *
 * If SetEntropy() is called with a Vector3D object it will return entropy density at @f$ s(x,y,z)
 * @f$ in other case it will return a constant value of entropy density.
 *
 * @fn Entropy::Entropy()
