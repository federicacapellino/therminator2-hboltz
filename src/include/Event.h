...
Created child particles are appended to the end of the list. Decay cascade continues until all unstable  particles decay and ParticleDecayer reaches the end of the list. 
