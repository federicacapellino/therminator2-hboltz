...
public:
  ...
  Hypersurface_Library* GetXMLTag(const char* aTagName, const char* aAttName,
                                  const char* aAttVal) noexcept(false);
 ...
 * @brief Destructor.
 *
 * @fn Hypersurface_Library* Hypersurface_Library::GetXMLTag(const char* aTagName, const char*
 * aAttName, const char* aAttVal) throw(int)
