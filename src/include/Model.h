...
#define MODEL_PAR_DESC(_name_, _unit_)                                                             \
  setw(8) << _name_ << " " << setw(7) << left << _unit_ << setw(5) << right << "#" << endl
#define MODEL_NAME(_name_) "# Model " << left << setw(36) << _name_ << right << "#" << endl
 ...
 * @param [in] aRandom pointer to <a href="http://root.cern.ch/root/html/TRandom2.html">TRandom2</a>
 ...
 * @brief Function called by EventGenerator to add a new <a
 * href="http://root.cern.ch/root/html/TBranch.html">TBranch</a> structure to an opened event <a
 * href="http://root.cern.ch/root/html/TFile.html">TFile</a>.
 *
 * This branch contains model parameters and model description.
 * @param [in] aTree pointer to the current <a
 * href="http://root.cern.ch/root/html/TTree.html">TTree</a> object.
 *
 * @fn void Model::SetParticlePX(Particle* aParticle)
 * @brief Fills the Particle with the coordinates and four momentum generated by the last call of
 * GetIntegrand.
 *
 ...
 * @brief random number generator, <a
 * href="http://root.cern.ch/root/html/TRandom2.html">TRandom2</a> class
 */
/*! @def MODEL_PAR_DESC(_name_,_unit_)
 * @brief Macro used by models in creating the Model description. Writes the parameter
 * <em>_name_</em> and its <em>_unit_</em> with a minimum number of characters.
 *
 * @def MODEL_NAME(_name_)
 * @brief Macro used by models in creating the Model description. Writes the model ID number and
 * <em>_name_</em>.
 */
