...
private:
  ...
  double SHAREClebschGordan(double aJot, double aEm, double aJot1, double aEm1, double aJot2,
                            double aEm2);
 ...
 * @brief Reads the XML file containing the definition of the hypersurface and fills the
