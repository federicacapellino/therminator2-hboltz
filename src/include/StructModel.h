...
#define _MODEL_T_FORMAT_BLASTWAVE_ "RapPSRange/F:RapSRange:RhoMax:Tau:Temp:MuB:MuI:MuS:MuC:Vt"
#define _MODEL_T_FORMAT_BWA_ "RapPRange/F:RapSRange:RhoMax:Tau:Temp:MuB:MuI:MuS:MuC:Vt:A:Delay"
#define _MODEL_T_FORMAT_LHYQUID2DBI_                                                               \
  "RapPRange/"                                                                                     \
  "F:RapSRange:TauI:TempF:MuB:MuI:MuS:MuC:CollidingEnergy:CentralityMin:CentralityMax:"            \
  "ImpactParameter:TempI:DeviceName[30]/C:CollidingSystem[30]"
#define _MODEL_T_FORMAT_LHYQUID3D_                                                                 \
  "RapPRange/"                                                                                     \
  "F:Lambda:TauI:TempF:MuB:MuI:MuS:MuC:CollidingEnergy:CentralityMin:CentralityMax:"               \
  "ImpactParameter:TempI:DeviceName[30]/C:CollidingSystem[30]"
...
struct Model_t_BlastWave {
  Float_t RapPSRange, RapSRange, RhoMax, Tau, Temp, MuB, MuI, MuS, MuC;
  Float_t Vt;
};
...
/*! @file StructModel.h
 * @brief Definition of Model_t and its derivatives structure. Model dependent parameters saved in a
 * <em>eventXXX.root</em> file.
 */
/*! @def _PARAMETERS_TREE_
 * @brief Macro with the name of the <a href="http://root.cern.ch/root/html/TTree.html">TTree</a>
 * with parameters and model description.
 *
 * @def _INTEGRATESAMPLE_BRANCH_
 * @brief Macro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a>
 * in the TTree with sIntegrateSample.
 *
 * @def _RANDOMIZE_BRANCH_
 * @brief Macro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a>
 * in the TTree with sRandomize.
 *
 * @def _STOREDEVENTS_BRANCH_
 * @brief Macro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a>
 * in the TTree with number of events stored in the file (see macro _EVENTS_PER_FILE_ in
 * EventGenerator.h ).
 *
 * @def _TIMESTAMP_BRANCH_
 * @brief Macro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a>
 * in the TTree with sTimeStamp.
 *
 * @def _MODELNAME_BRANCH_
 * @brief Macro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a>
 * in the TTree with Model::mName.
 *
 * @def _MODELHASH_BRANCH_
 * @brief Macro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a>
 * in the TTree with Model::mHash.
 *
 * @def _MODELDESCRIPTION_BRANCH_
 * @brief Macro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a>
 * in the TTree with Model::mDescription.
 *
 * @def _MODEL_T_BRANCH_
 * @brief Macro with the name of a <a href="http://root.cern.ch/root/html/TBranch.html">TBranch</a>
 * in the TTree with a model dependent structure with its parameters.
 *
 ...
 * @brief @f$ \Lambda \,[GeV^{-1}]@f$, conversion constant to spatial rapidity @f$
 * \eta_\parallel^{max} = d(\zeta,\phi,\theta = 0) / \Lambda @f$
 *
 ...
 * @brief (optional) @f$ T_i \,[MeV] @f$, temperature in the center of the fireball at time @f$
 * \tau_i @f$
 *
