 ...
 * @brief Part of the debugging system. Sends <em>_mes</em> to std::cerr if the compilation variable
 * <em>_DEBUG_LEVEL_ >= 1</em>
 *
 * @def PRINT_DEBUG_2(_mes)
 * @brief Part of the debugging system. Sends <em>_mes</em> to std::cerr if the compilation variable
 * <em>_DEBUG_LEVEL_ >= 2</em>
 *
 * @def PRINT_DEBUG_3(_mes)
 * @brief Part of the debugging system. Sends <em>_mes</em> to std::cerr if the compilation variable
 * <em>_DEBUG_LEVEL_ = 3</em>
 */
