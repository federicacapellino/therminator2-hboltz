 ...
 *
 * If SetTemperature() is called with a Vector3D object it will return the temperature at @f$
 * T(x,y,z) @f$ in other case it will return a constant value of temperature.
 *
