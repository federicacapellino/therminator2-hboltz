...
enum eViscPi { i00, i0X, i0Y, i0Z, iXX, iXY, iXZ, iYY, iYZ, iZZ };
...
public:
  ...
  double GetShearPPdotPi(double aX, double aY, double aZ, double aPe, double aPx, double aPy,
                         double aPz) const;
...
/*! @file Viscosity.h
 * @brief Definition of Viscosity class. Contains the bulk @f$ \Pi @f$ and shear viscosity tensor
 * @f$ \pi^{/mu/nu} @f$.
 ...
 *
 * @fn double Viscosity::GetShearPPdotPi(double aX, double aY, double aZ, double aPe, double aPx,
 * double aPy, double aPz) const
