...
const unsigned int Crc32::mCrc32Tab[] = {
...
Crc32::Crc32() : mCrc32(0xFFFFFFFF) {}

Crc32::Crc32(const char* aData, unsigned int aSize) : mCrc32(0xFFFFFFFF) {
  Update(aData, aSize);
}

Crc32::~Crc32() {}

void Crc32::Update(const char* aData, unsigned int aSize) {
  for (unsigned int i = 0; i < aSize; i++)
    mCrc32 = (mCrc32 >> 8) ^ mCrc32Tab[(aData[i]) ^ (mCrc32 & 0x000000FF)];
}

unsigned int Crc32::Finish() const {
  mCrc32 = ~mCrc32;
  return mCrc32;
}

unsigned int Crc32::GetValue() const {
  return mCrc32;
}

const char* Crc32::GetValueHex() {
  ostringstream oss;
