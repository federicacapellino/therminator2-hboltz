...
std::atomic<long> Particle::EIDi{0};

static std::string buffer = std::string();

Particle::Particle() : ParticleCoor(), mPartType(0) {}

Particle::Particle(ParticleType* aType) : ParticleCoor(), mPartType(aType) {
...
void Particle::SetParticlePX(double aPe, double aPx, double aPy, double aPz, double aXt, double aXx,
                             double aXy, double aXz, double aWeight) {
